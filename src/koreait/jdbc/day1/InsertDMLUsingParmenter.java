...
public class InsertDMLUsingParmenter {
   ...
   public static void main(String[] args) {
         ...
         //insert SQL 작성: 실행되는 값이 되도록 매개변수로 처리한다. 이 떄 매개변수 기호는'?'이다.
         ...
         //setXXXX 메소드의 첫번째 인자는 매개변수의 인덱스, 두번째 인자는 값이다.XXXX는 매개변수의 타입이다.
         pstmt.setString(1,"2023003"); // 1번인덱스는 "2023003" 대입이된다.
